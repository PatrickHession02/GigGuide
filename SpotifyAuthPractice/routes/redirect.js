...
router.post("/", express.json(), (req, res) => {
  ...
  spotifyApi
    ...
    .then((data) => {
      ...
      console.log("Access token:", accessToken); //settting the access token
      ...
      spotifyApi
        ...
        .then((response) => {
          ...
          // Saving the top artists to the Firebase database
          ...
          docRef
            ...
            .then(() => {
              ...
              res.json({
                message: "Top artists saved to Firebase",
                topArtists: topArtists,
              });
            })
            .catch((err) => {
    ...
    .catch((err) => {
      ...
      res.send(
        "Error exchanging code for access token. Please try again later.",
      );
    });
});
